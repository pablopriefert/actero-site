...
export const WEBHOOK_EVENTS = [
  ...
  { id: 'usage.threshold_reached', label: 'Seuil de consommation', description: '80% du quota mensuel atteint' },
  { id: 'usage.quota_reached', label: 'Quota atteint', description: 'Quota mensuel épuisé — l\'agent est en pause' },
