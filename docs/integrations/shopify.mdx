...
<Steps>
  ...
  <Step title="Le widget s'injecte tout seul">
    Avec les scopes `read_themes` / `write_themes` accordés, Actero injecte le widget de chat dans le thème actif de ta boutique. Les 30 dernières commandes sont indexées en moins de 20 secondes.
  </Step>
</Steps>
