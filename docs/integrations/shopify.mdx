...
Tu as **un seul domaine Shopify par compte Actero**, quel que soit ton plan. Si tu gères deux marques distinctes, crée un second compte Actero — chaque agent reste isolé et garde son ton, sa base de connaissances et ses métriques.
