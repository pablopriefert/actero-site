...
<Steps>
  <Step title="Ouvre la fiche Actero sur le Shopify App Store">
    Depuis le [Shopify App Store](https://apps.shopify.com), cherche **Actero** et clique **Ajouter l'app**. Tu peux aussi partir d'Actero : **Intégrations → Shopify → Connecter** te redirige vers la fiche Actero sur l'App Store — aucune adresse à saisir, Shopify sait de quelle boutique il s'agit.
  </Step>
  ...
  <Step title="Approuve l'installation">
    Tu reviens automatiquement sur `actero.fr`, sur une page qui confirme que ta boutique est connectée. L'installation est gratuite et aucune carte bancaire n'est demandée. Si tu passes ensuite sur un plan payant, il est facturé via Shopify et apparaît sur ta facture Shopify.
  </Step>
