...
Actero vérifie **au moins toutes les 24 heures** que le script Actero est bien présent sur ta vitrine. Le contrôle est automatique dès que ton onboarding Shopify est terminé — rien à activer.
