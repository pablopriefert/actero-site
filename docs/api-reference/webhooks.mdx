---
title: "Webhooks"
description: "Reçois les événements de l'agent Actero via webhook HTTP POST signé HMAC-SHA256 : configuration dashboard, livraisons rejouables et signature vérifiable."
---
