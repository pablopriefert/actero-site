---
title: "Webhooks"
description: "Webhooks Actero : reçois les événements de l'agent en HTTP POST signé HMAC-SHA256, avec livraisons rejouables et signatures vérifiables côté serveur."
---
