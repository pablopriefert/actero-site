---
title: "Webhooks"
description: "Reçois les événements Actero (tickets, escalades, quota) en HTTP POST signé HMAC-SHA256 : configuration, signature vérifiable, livraisons rejouables."
---
