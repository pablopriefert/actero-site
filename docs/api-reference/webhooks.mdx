---
title: "Webhooks"
description: "Reçois les événements de l'agent Actero en HTTP POST signé HMAC-SHA256 : configuration dans le dashboard, livraisons rejouables et signatures vérifiables."
---
