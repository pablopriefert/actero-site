---
title: "Rate Limits"
description: "Limites de l'API Actero par client, par customer et par IP : codes 429, en-têtes de quota, stratégie de retry avec back-off exponentiel et bonnes pratiques."
---
