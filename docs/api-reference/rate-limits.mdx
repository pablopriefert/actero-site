---
title: "Rate Limits"
description: "Rate limits de l'API Actero par client, par customer et par IP : codes 429, headers X-RateLimit, stratégie de retry exponentiel et bonnes pratiques."
---
