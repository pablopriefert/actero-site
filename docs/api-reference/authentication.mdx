...
description: "Authentification de l'API Actero : Bearer JWT pour la session dashboard, clé API pour les intégrations serveur, secret partagé pour l'engine interne."
---
