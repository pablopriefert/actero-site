...
description: "Export RGPD complet du tenant Actero : conversations, runs agent, événements, métriques, intégrations et base de connaissance, au format JSON ou CSV."
---
