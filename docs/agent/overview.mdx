...
<Steps>
  ...
  <Step title="Récupération de contexte Shopify">
    ...
    Pour un visiteur anonyme du widget qui donne seulement un numéro de commande, l'agent demande d'abord l'email d'achat avant de divulguer le moindre détail. Un numéro seul ne suffit jamais : il faut que le numéro **et** l'email correspondent à la même commande côté plateforme. Cette règle s'applique à Shopify, WooCommerce et Webflow.
  </Step>
