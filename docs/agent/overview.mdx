...
<CardGroup cols={2}>
  ...
  <Card title="Playbooks" icon="zap">
    Les automatisations actives (SAV e-commerce, relance panier, compta).
  </Card>
</CardGroup>
...
Voici ce qui se passe quand un client envoie "Bonjour, où est ma commande #1042 ?" via ton widget de chat. Ce cycle complet s'applique aux quatre canaux de messages : **widget**, **email**, **Gorgias** et **Zendesk**. Seul le canal vocal fonctionne différemment, voir [Couverture par canal](#couverture-par-canal).
...
Les quatre canaux de messages passent par le cycle complet ci-dessus : classification, sous-agents spécialisés, guardrails, escalade.

| Canal | Traitement |
|---|---|
| **Widget de chat** | Cycle complet |
| **Email** (Gmail, SMTP/IMAP) | Cycle complet |
| **Gorgias** | Cycle complet. La réponse est postée directement dans le ticket Gorgias. |
| **Zendesk** | Cycle complet. La réponse est postée directement dans le ticket Zendesk. |
| **Intercom** | Pas encore pris en charge. La connexion OAuth fonctionne, mais l'agent ne reçoit pas les conversations Intercom. |
