...
Tu dois être notifié dans Slack ou par email dès qu'un signup tombe pour réagir en moins d'1h. Si ça manque, Task 7 l'ajoute.
...
Dès qu'un signup arrive, réagir en moins d'1h.
