...
const ROUTES = [
  ...
  {
    path: '/startups',
    title: 'Actero pour les startups — 50% off pendant 6 mois',
    description: 'Programme Actero for Startups : 50% de réduction pendant 6 mois pour les jeunes pousses e-commerce. Conditions et candidature en ligne.',
    h1: 'Actero pour les startups',
  },
  {
    path: '/produit',
    title: 'Produit Actero — Agent IA SAV Shopify autonome',
    description: 'Découvrez l\'agent IA Actero : classification tickets, réponses automatiques, escalade, intégration Shopify, helpdesk, analyse photo.',
