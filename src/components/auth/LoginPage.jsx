          ...
          {!isForgot && (
            <>
              ...
              <div className="grid grid-cols-3 gap-3">
                <button
                  type="button"
                  className="flex items-center justify-center py-3 rounded-xl bg-surface border border-gray-200 hover:bg-gray-100 transition-all"
                  disabled
                >
                ...
                <button
                  ...
                  disabled={loading}
                  className="flex items-center justify-center py-3 rounded-xl bg-surface border border-gray-200 hover:bg-gray-100 transition-all disabled:opacity-50"
                >
