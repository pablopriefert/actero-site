...
export function SetPasswordPage({ onNavigate }) {
  ...
  if (success) {
    return (
      <div className="min-h-screen bg-surface flex flex-col justify-center items-center px-6 font-sans">
      ...
      <div className="hidden lg:block lg:w-1/2 relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center px-12">
            <div className="w-20 h-20 bg-surface rounded-3xl border border-gray-200 flex items-center justify-center mx-auto mb-8">
