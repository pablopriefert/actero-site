        ...
        <div className="bg-white py-8 px-4 shadow-lg border border-gray-200 sm:rounded-3xl sm:px-10">
          <form className="space-y-6" onSubmit={handleUpdate}>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex justify-center py-3.5 px-4 rounded-full shadow-sm text-sm font-bold text-white bg-cta hover:bg-cta disabled:opacity-50 transition-colors"
            >
