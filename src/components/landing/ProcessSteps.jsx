...
const MockupAudit = ({ isImmo }) => (
  <div className="bg-surface rounded-xl border border-gray-200 p-4 text-[11px] font-mono">
          ...
          >
            <div className="p-6 md:p-7">
              ...
              <div className="flex items-center justify-between mb-5">
                ...
                <span className="text-xs font-bold text-gray-400 bg-surface px-3 py-1 rounded-full">{block.detail}</span>
              </div>
