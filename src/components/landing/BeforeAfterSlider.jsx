        ...
        <div className="relative rounded-3xl overflow-hidden border border-gray-200">
          <div className="grid md:grid-cols-2">
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              className="p-8 md:p-10 bg-surface/30"
            >
              <div className="flex items-center gap-3 mb-8">
                <div className="w-10 h-10 rounded-2xl bg-surface border border-[#003725]/20 flex items-center justify-center">
              ...
              <div className="space-y-5">
                {afterItems.map((item, i) => (
                  <motion.div
                    ...
                    className="flex gap-3"
                  >
                    <div className="w-8 h-8 rounded-xl bg-surface flex items-center justify-center flex-shrink-0 mt-0.5">
              ...
              <div className="mt-8 p-4 rounded-2xl bg-surface border border-[#003725]/20">
                <div className="flex items-center justify-between">
