  ...
  return (
    <div className="grid md:grid-cols-2 gap-8 items-center max-w-5xl mx-auto">
      ...
      <div className="flex justify-center">
        <div className="w-80 bg-surface rounded-[32px] border border-gray-200 overflow-hidden shadow-lg">
          {/* Status bar */}
          ...
          <div className="p-4 space-y-2.5 min-h-[340px] flex flex-col justify-end bg-white">
              ...
              {messages.slice(0, visibleCount).map((msg, i) => (
                ...
                >
                  <div className={`max-w-[82%] px-3.5 py-2.5 rounded-2xl text-[12px] leading-relaxed border ${
                    msg.from === 'agent'
                      ? 'bg-surface border-gray-200 text-gray-800 rounded-tl-sm'
            ...
            <AnimatePresence>
              {isTyping && (
                ...
                >
                  <div className="bg-surface border border-gray-200 px-4 py-3 rounded-2xl rounded-tl-sm flex gap-1 items-center">
                    {[0, 1, 2].map(i => (
                      <motion.span
                        key={i}
          ...
          {/* Input bar */}
          <div className="bg-surface px-4 py-3 flex items-center gap-3 border-t border-gray-200">
