        ...
        >
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-6">
              <span className="text-[10px] font-black tracking-[0.2em] uppercase px-3 py-1.5 rounded-lg border text-[#716D5C] bg-surface border-gray-200">
            ...
            <div className="bg-surface border border-gray-200 rounded-xl px-4 py-3 mb-6">
