          ...
          >
            <div className="flex items-start justify-between gap-3 mb-2">
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-lg bg-[#0F5F35]/10 text-[#0F5F35] flex items-center justify-center">
                  <Sparkles className="w-4 h-4" />
                </div>
                <span className="text-[11px] font-semibold text-[#0F5F35] uppercase tracking-wider">
            ...
            <div className="flex items-center justify-between gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  onClick={handleNext}
                  className="flex items-center gap-1 px-3.5 py-1.5 rounded-lg text-[12px] font-semibold bg-[#0F5F35] text-white hover:bg-[#0c4d2a] transition-colors"
                >
