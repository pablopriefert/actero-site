...
const GUIDES = [
  ...
  { id: 'problèmes', category: 'getting-started', title: 'Problèmes fréquents', summary: 'Solutions aux problèmes courants.', icon: HelpCircle, readTime: '4 min',
  ...
  // Integrations
  { id: 'connecter-shopify', category: 'intégrations', title: 'Connecter Shopify', summary: 'Connecter votre boutique en 1 clic.', icon: ShoppingBag, readTime: '2 min',
    content: "1. Allez dans Intégrations\n2. Cliquez 'Connecter' sur Shopify\n3. Vous êtes redirigé vers la fiche Actero sur l'App Store Shopify\n4. Cliquez 'Installer' et autorisez les accès demandés\n5. Retour automatique sur Actero avec 'Connecté' affiché\n\nVous n'avez aucune adresse à saisir : Shopify transmet votre boutique.\n\nShopify est nécessaire pour : le widget chat sur le site, le suivi des commandes, la relance paniers abandonnés." },
  { id: 'connecter-gmail', category: 'intégrations', title: 'Connecter Gmail', summary: 'Recevoir et répondre aux emails.', icon: Mail, readTime: '2 min',
  ...
  { id: 'connecter-smtp', category: 'intégrations', title: 'Connecter un email SMTP/IMAP', summary: 'Utiliser votre email professionnel.', icon: Mail, readTime: '4 min',
  ...
  { id: 'connecter-slack', category: 'intégrations', title: 'Connecter Slack', summary: 'Recevoir les alertes dans Slack.', icon: MessageSquare, readTime: '2 min',
  ...
  { id: 'connecter-gorgias', category: 'intégrations', title: 'Connecter Gorgias', summary: 'Traiter les tickets Gorgias automatiquement.', icon: Headphones, readTime: '2 min',
  ...
  { id: 'connecter-zendesk', category: 'intégrations', title: 'Connecter Zendesk', summary: 'Traiter les tickets Zendesk automatiquement.', icon: Headphones, readTime: '2 min',
    content: "1. Allez dans Intégrations\n2. Cliquez 'Connecter' sur Zendesk\n3. Entrez votre sous-domaine Zendesk\n4. Autorisez Actero\n5. C'est connecté !\n\nL'agent répondra aux tickets Zendesk automatiquement." },
  { id: 'connecter-comptabilité', category: 'intégrations', title: 'Connecter Axonaut, Pennylane ou iPaidThat', summary: 'Automatiser la comptabilité.', icon: TrendingUp, readTime: '3 min',
  ...
  { id: 'relance-paniers', category: 'automatisations', title: 'Relance Paniers Abandonnés', summary: 'Récupérer les ventes perdues.', icon: ShoppingBag, readTime: '2 min',
    content: "Quand un client abandonné son panier sur votre boutique Shopify, l'agent envoie un email de relance personnalisé.\n\nNécessite : Shopify connecté + Email (Gmail ou SMTP)\n\nL'email est personnalisé avec le prénom du client et les produits laissés dans le panier." },
  { id: 'comptabilité-comment-ça-marche', category: 'automatisations', title: 'Comptabilité automatisée : comment ça marche', summary: 'Tout comprendre sur l\'automatisation comptable.', icon: TrendingUp, readTime: '6 min',
  ...
  { id: 'règles', category: 'agent-ia', title: 'Définir vos règles', summary: 'Ce que l\'agent ne doit jamais faire.', icon: Shield, readTime: '3 min',
  ...
  { id: 'conflits-intégrations', category: 'intégrations', title: 'Conflits d\'intégrations', summary: 'Pourquoi certaines intégrations sont exclusives.', icon: Plug, readTime: '2 min',
  ...
  { id: 'export-données', category: 'dashboard', title: 'Exporter mes données', summary: 'Récupérer vos conversations et métriques.', icon: BarChart3, readTime: '2 min',
