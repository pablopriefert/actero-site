              ...
              {status === 'sent' ? (
                ...
                <>
                  ...
                  <button
                    ...
                    className="w-full mt-4 py-2.5 rounded-xl bg-cta text-white text-sm font-semibold hover:bg-cta transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
                  >
                    {status === 'sending' ? (
                      <>
