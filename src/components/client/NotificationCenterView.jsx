...
const NOTIFICATION_TYPES = [
  {
    ...
    color: 'text-red-500',
    items: [
      { key: 'escalation_alert', label: 'Ticket escalade', desc: 'Quand un ticket necessite votre intervention', channels: ['email', 'slack', 'push'], defaultChannels: ['email'] },
      { key: 'urgent_ticket_alert', label: 'Ticket urgent / agressif', desc: 'Message detecte comme agressif ou urgent', channels: ['email', 'slack', 'push'], defaultChannels: ['email'] },
      { key: 'anomaly_alert', label: 'Anomalie detectee', desc: 'Pic de tickets ou baisse de performance soudaine', channels: ['email', 'slack', 'push'], defaultChannels: ['email'] },
      { key: 'security_alert', label: 'Tentative d\'injection', desc: 'Un message suspect a ete bloque par la securite IA', channels: ['email', 'slack'], defaultChannels: [] },
      { key: 'negative_sentiment', label: 'Sentiment tres negatif', desc: 'Un client avec un score sentiment < 3/10', channels: ['email', 'slack', 'push'], defaultChannels: [] },
    ],
  },
  {
    section: 'Rapports',
    ...
    color: 'text-blue-500',
    items: [
      { key: 'daily_summary', label: 'Resume quotidien', desc: 'Email chaque matin avec les performances de la veille', channels: ['email'], defaultChannels: ['email'] },
      { key: 'weekly_summary', label: 'Resume hebdomadaire', desc: 'Rapport chaque lundi avec tendances et insights', channels: ['email', 'vocal'], defaultChannels: [] },
      { key: 'monthly_report', label: 'Rapport mensuel PDF', desc: 'Rapport detaille en fin de mois avec ROI et KPIs', channels: ['email'], defaultChannels: ['email'] },
      { key: 'voice_report', label: 'Rapport vocal', desc: 'Resume audio de 90 secondes de vos metriques', channels: ['vocal'], defaultChannels: [] },
    ],
  },
  {
    section: 'Activite',
    ...
    items: [
      { key: 'new_integration', label: 'Integration connectee', desc: 'Quand une nouvelle integration est activee', channels: ['email', 'slack'], defaultChannels: [] },
      { key: 'agent_improvement', label: 'Suggestion d\'amelioration', desc: 'L\'IA a identifie un pattern a corriger', channels: ['email'], defaultChannels: ['email'] },
      { key: 'milestone_alert', label: 'Jalon atteint', desc: '100h economisees, 1000 tickets resolus, etc.', channels: ['email', 'push'], defaultChannels: ['email'] },
    ],
  },
]
