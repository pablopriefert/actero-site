  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      <div
        ...
        onClick={onClose}
      ></div>
      <div className="bg-surface rounded-2xl w-full max-w-lg relative z-10 shadow-xl overflow-hidden animate-fade-in-up border border-gray-200">
        <div className="p-6 md:p-8 flex items-center justify-between border-b border-gray-100 bg-white">
          ...
          <button
            onClick={onClose}
            className="p-2 bg-surface rounded-full border border-gray-200 text-[#716D5C] hover:bg-gray-50 hover:text-[#262626] shadow-sm transition-colors"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
        <div className="p-6 md:p-8 space-y-6">
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                onClick={copyId}
                className="p-2 bg-surface border border-gray-200 rounded-lg hover:bg-gray-50 text-[#716D5C] transition-colors shadow-sm"
                title="Copier l'ID"
              >
