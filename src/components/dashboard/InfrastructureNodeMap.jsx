...
export const InfrastructureNodeMap = ({ theme = "dark" }) => {
  ...
  return (
    <div
      className={`rounded-3xl border p-8 shadow-sm relative overflow-hidden h-[400px] flex items-center justify-center transition-colors duration-300 ${isLight ? "bg-white border-gray-200" : "bg-surface border-gray-200"
        }`}
    >
      {/* Background grid */}
      <div
      ...
      <div className="relative z-10 flex items-center gap-12 lg:gap-24 w-full justify-center">
        ...
        <div className="flex flex-col items-center gap-3">
          <div
            className={`w-16 h-16 border rounded-2xl flex items-center justify-center shadow-lg backdrop-blur-md relative group ${isLight ? "bg-surface border-gray-200" : "bg-gray-50 border-gray-200"
              }`}
          >
            <ShoppingCart
        ...
        <div className="flex flex-col items-center gap-3">
          <div
            className={`w-20 h-20 border rounded-full flex items-center justify-center relative ${isLight
              ? "bg-surface border-gray-200 shadow-xl"
