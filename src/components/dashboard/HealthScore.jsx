...
export function HealthScoreIndicator({ metricsData, eventsData, theme = "dark" }) {
  ...
  return (
    <div className={`flex items-center gap-2 px-3 py-1.5 rounded-lg border ${isLight ? "bg-surface border-gray-200" : "bg-gray-50 border-gray-200"}`}>
...
export function HealthScoreWidget({ metricsData, eventsData, theme = "dark" }) {
  ...
  return (
    <div className={`p-6 rounded-2xl border transition-all ${isLight ? "bg-white border-gray-200" : "bg-surface border-gray-200"}`}>
