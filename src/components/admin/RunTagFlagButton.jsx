          ...
          >
                  ...
                  >
                    ...
                    <span
                      className={`w-3.5 h-3.5 rounded-full border flex items-center justify-center flex-shrink-0 ${
                        selected ? 'border-[#0F5F35]' : 'border-[#f0f0f0]'
                      }`}
                    >
                      {selected && <span className="w-1.5 h-1.5 rounded-full bg-[#0F5F35]" />}
                    </span>
            ...
            <div className="mb-3">
              ...
              <textarea
                ...
                className="w-full text-[12px] text-[#1a1a1a] bg-[#fafafa] border border-[#f0f0f0] rounded-lg px-2.5 py-2 resize-none focus:outline-none focus:border-[#0F5F35]/30 focus:bg-white transition-colors"
              />
            ...
            <div className="flex items-center justify-end gap-2">
              ...
              <button
                ...
                disabled={submitting}
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#0F5F35] hover:bg-[#0b4a29] text-white text-[12px] font-semibold transition-colors disabled:opacity-60"
              >
