      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-xl bg-[#0F5F35] text-white text-sm font-semibold hover:bg-[#003725] transition-colors"
          >
        ...
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4" onClick={() => setShowCreate(false)}>
          ...
          >
            ...
            <button
              ...
              className="w-full mt-5 py-2.5 rounded-xl bg-[#0F5F35] text-white text-sm font-semibold hover:bg-[#003725] transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
            >
          ...
          >
            <div className="flex items-center justify-between mb-2">
              <h3 className="text-lg font-bold text-[#1a1a1a] flex items-center gap-2">
                <Mail className="w-5 h-5 text-[#0F5F35]" />
