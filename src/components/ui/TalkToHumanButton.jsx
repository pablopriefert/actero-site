...
export function TalkToHumanButton({
  ...
  const variantClasses = {
    light:
      'bg-transparent text-[#262626] border border-black/10 hover:border-black/20 hover:bg-surface',
    dark:
      'bg-transparent text-white border border-[#F4F5F7]/25 hover:bg-white/10',
    ghost:
      'bg-transparent text-[#716D5C] border border-transparent hover:text-[#262626] hover:bg-surface',
  }
