    ...
    <div className="min-h-screen bg-white text-[#262626] font-sans selection:bg-[#003725]/10 relative overflow-hidden flex flex-col">
      ...
      <main className="pt-32 pb-24 relative z-10 flex-grow px-6">
        ...
        {ambassadorRef && !referralCode && (
          ...
          >
            <div className="relative overflow-hidden rounded-2xl border border-[#0F5F35]/20 bg-[#0F5F35]/5 p-6">
              <div className="relative flex items-center gap-4">
                <div className="w-12 h-12 rounded-xl bg-[#0F5F35]/10 border border-[#0F5F35]/20 flex items-center justify-center flex-shrink-0">
                  <Gift className="w-6 h-6 text-[#0F5F35]" />
                </div>
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-[#0F5F35]/10 border border-[#0F5F35]/20 text-[#003725] text-xs font-bold">
            ...
            <div className="relative overflow-hidden rounded-2xl border border-violet-200 bg-violet-50 p-6">
              <div className="relative flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <h3 className="text-lg font-bold text-[#262626]">
                    Vos frais de setup de <span className="line-through text-[#716D5C]">800€</span> sont <span className="text-[#0F5F35]">offerts</span>
                  </h3>
                  <p className="text-sm text-[#716D5C] mt-1">
          ...
          <FadeInUp>
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-10">
                  ...
                  <ul className="space-y-4">
                    {[
                      ...
                      <li key={i} className="flex items-center gap-3">
                        <div className="w-5 h-5 rounded-full bg-[#0F5F35]/10 text-[#0F5F35] flex items-center justify-center border border-[#0F5F35]/20 flex-shrink-0">
                ...
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#0F5F35]/10 border border-[#0F5F35]/20 text-xs font-bold text-[#003725]">
        ...
        <section className="py-24 mt-12 bg-[#F9F7F1] relative z-10 border-t border-gray-200 -mx-6 px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <FadeInUp delay={0.3}>
                <div className="bg-white rounded-2xl p-8 border border-gray-200 h-full hover:border-gray-300 transition-colors">
                  <div className="w-12 h-12 bg-[#0F5F35]/10 rounded-xl flex items-center justify-center mb-6 text-[#0F5F35]">
