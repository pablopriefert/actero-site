                  ...
                  <form onSubmit={handleSubmit} className="space-y-5 bg-white p-8 rounded-2xl border border-gray-200 shadow-sm">
                    <div>
                      ...
                      <input
                        ...
                        required
                        minLength={2}
                        className="w-full px-4 py-3 bg-surface border border-gray-200 rounded-xl text-[#262626] placeholder-gray-500 outline-none focus:border-indigo-500/40 transition-colors"
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        minLength={20}
                        rows={5}
                        className="w-full px-4 py-3 bg-surface border border-gray-200 rounded-xl text-[#262626] placeholder-gray-500 outline-none focus:border-indigo-500/40 transition-colors resize-none"
