  ...
  return (
    <>
      <SEO
        ...
        description="Mentions legales du site actero.fr — identité de l'editeur, hébergement, propriete intellectuelle."
            ...
            <div className="space-y-12">
              ...
              <section>
                ...
                <div className="text-[#716D5C] leading-relaxed text-[15px] space-y-3">
                  <p>
                    L'ensemble du contenu du site actero.fr (textes, images, logos, icones, logiciels, base de données) est la propriete exclusive d'Actero ou de ses partenaires et est protege par les lois francaises et internationales relatives a la propriete intellectuelle.
                  </p>
                  <p>
              ...
              <section>
                ...
                <div className="text-[#716D5C] leading-relaxed text-[15px] space-y-3">
                  <p>
                    Actero s'engage a proteger les données personnelles de ses utilisateurs conformement au Règlement Général sur la Protection des Données (RGPD) et a la loi Informatique et Libertes.
                  </p>
                  <p>
              ...
              <section>
                ...
                <div className="text-[#716D5C] leading-relaxed text-[15px] space-y-3">
                  <p>
                    Le site actero.fr utilise des cookies strictement necessaires au fonctionnement du service (authentification, session utilisateur). Des cookies d'analyse anonymisee (Amplitude) peuvent egalement être utilises pour améliorer l'experience utilisateur.
                  </p>
                  <p>
              ...
              <section>
                ...
                <div className="text-[#716D5C] leading-relaxed text-[15px] space-y-3">
                  ...
                  <p>
                    Actero decline toute responsabilite pour les dommages directs ou indirects resultant de l'accès ou de l'utilisation du site, y compris l'inaccessibilite, les pertes de données, les deteriorations, ou les virus pouvant affecter l'equipement informatique de l'utilisateur.
                  </p>
                </div>
                <div className="mt-6 h-px bg-gray-200" />
              </section>
              ...
              <section>
                ...
                <p className="text-[#716D5C] leading-relaxed text-[15px]">
                  Le site actero.fr peut contenir des liens vers des sites tiers. Actero n'exerce aucun contrôle sur ces sites et decline toute responsabilite quant a leur contenu. L'insertion de ces liens ne constitue pas une approbation de leur contenu.
                </p>
                <div className="mt-6 h-px bg-gray-200" />
              </section>
