      ...
      <div className="relative w-full">
        ...
        <main>
          ...
          <div className="relative w-full z-10">
              ...
              <FadeInUp className="max-w-5xl mx-auto text-center">
                ...
                {vertical === 'ecommerce' ? (
                  <>
                    ...
                    <p className="text-xl md:text-2xl text-gray-600 font-medium max-w-3xl mx-auto leading-relaxed mb-20">
                    ...
                    >
                      <Tilt3D intensity={8} className="w-full">
                        <div className="bg-white border border-gray-200 rounded-2xl p-6 md:p-8 flex flex-col items-center hover:border-gray-200 transition-colors duration-300">
                          ...
                          <p className="text-4xl md:text-5xl font-bold text-gray-900 mb-3 tracking-tight">
                            <ScrollCounter value={block.statValue} suffix={block.statSuffix} />
                          </p>
                          <h3 className="text-lg font-bold text-gray-900 mb-3">
                            {block.title}
                          </h3>
                          <p className="text-base text-gray-500 font-medium leading-relaxed max-w-xs">
                            {block.desc}
                          </p>
                        </div>
                      </Tilt3D>
            ...
            {/* Section separator */}
            <div className="mx-auto max-w-5xl px-6"><div className="h-px bg-gray-200" /></div>
            ...
            <section className="py-24 md:py-32 bg-white px-6 relative z-10">
              <div className="max-w-6xl mx-auto">
                <FadeInUp className="text-center mb-20">
                  <p className={`text-xs font-bold uppercase tracking-[0.2em] mb-6 ${vertical === 'immobilier' ? 'text-[#1B7D3A]' : 'text-[#1B7D3A]'}`}>
            ...
            <section className="py-24 md:py-32 bg-white px-6 relative z-10">
              <div className="max-w-6xl mx-auto">
                <FadeInUp className="text-center mb-16">
                  <p className={`text-xs font-bold uppercase tracking-[0.2em] mb-4 ${vertical === 'immobilier' ? 'text-[#1B7D3A]' : 'text-[#1B7D3A]'}`}>
                    En action 24h/24
                  </p>
                ...
                <FadeInUp delay={0.5} className="mt-10">
                  <div className="bg-gray-50 rounded-3xl p-8 md:p-10 border border-gray-200">
                    <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                      <div>
                        <p className="text-xs font-bold uppercase tracking-widest text-gray-500 mb-2">Résultat</p>
                        <p className="text-xl md:text-2xl font-bold text-gray-900 leading-snug">
                          {vertical === 'ecommerce'
                            ? <>Un système qui tourne <span className="text-gray-500">24h/24</span>, optimise vos marges en continu, <br className="hidden md:block" />piloté par un account manager dédié.</>
                            : <>3 agents IA qui travaillent <span className="text-gray-500">24h/24</span> pour votre agence, <br className="hidden md:block" />pilotés par un account manager dédié.</>
                          }
                        </p>
                      </div>
                      <MagneticButton
                        onClick={() => onNavigate("/audit")}
                        className="flex-shrink-0 bg-[#1B7D3A] text-white px-8 py-4 rounded-full font-bold flex items-center gap-2 hover:bg-[#166B32] transition-colors"
                      >
            ...
            {/* ============================================ */}
            <section id="proof" className="py-24 bg-white px-6 relative z-10">
              <div className="max-w-6xl mx-auto">
                <FadeInUp className="text-center mb-16">
                  <p className="text-xs font-bold text-gray-500 uppercase tracking-[0.2em] mb-6">
                    Résultats mesurés
                ...
                <FadeInUp className="mb-16">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-0 max-w-4xl mx-auto">
                    {(vertical === 'ecommerce' ? [
                      { value: 120, prefix: "+", suffix: "h", label: "Libérées par mois côté support", color: "text-gray-900" },
                      { value: 15, prefix: "+", suffix: "%", label: "De revenus récupérés via relances", color: "text-[#1B7D3A]" },
                      { value: 80, prefix: "", suffix: "%", label: "Des demandes traitées sans humain", color: "text-gray-900" },
                    ] : [
                      { value: 30, prefix: "+", suffix: "%", label: "De rendez-vous confirmés", color: "text-gray-900" },
                      { value: 50, prefix: "-", suffix: "%", label: "De temps administratif", color: "text-[#1B7D3A]" },
                      { value: 10, prefix: "+", suffix: "%", label: "De prospects réactivés", color: "text-gray-900" },
                    ]).map((stat, i) => (
                      ...
                      {vertical === 'ecommerce' ? (
                        <>
                          <div className="flex items-center gap-3 mb-10">
                            <div className="px-3 py-1 bg-gray-50 border border-gray-200 rounded-full text-xs font-bold uppercase tracking-widest text-gray-600">Exemple de déploiement</div>
                            <span className="text-gray-900 font-bold">Marque e-commerce Beauté — Shopify</span>
                          </div>
                          <div className="grid md:grid-cols-2 gap-12 items-center">
                            <div className="space-y-8">
                              <div>
                                <p className="text-xs font-bold uppercase tracking-widest text-gray-500 mb-1">Problème identifié</p>
                                <p className="text-xl font-bold text-gray-900 leading-tight">Support saturé (60+ tickets/jour) et taux d'abandon panier à 78%.</p>
                              </div>
                              <div>
                                <p className="text-xs font-bold uppercase tracking-widest text-gray-500 mb-1">Solution déployée</p>
                                <p className="text-base text-gray-500 font-medium leading-relaxed">Agent IA support N1 + séquences de relance personnalisées + dashboard de monitoring en temps réel.</p>
                              </div>
                              <div className="flex gap-12">
                                <div>
                                  <p className="text-xs font-bold uppercase tracking-widest text-gray-500 mb-1">Avant</p>
                                  <p className="text-2xl font-bold text-gray-500 line-through">AOV 65 €</p>
                                </div>
                                <div>
                                  <p className="text-xs font-bold uppercase tracking-widest text-[#1B7D3A] mb-1">Après 30 jours</p>
                                  <p className="text-3xl font-bold text-gray-900 tracking-tight">AOV 82 €</p>
                                </div>
                              </div>
                            </div>
                            <div className="bg-white rounded-3xl p-8 border border-gray-200 shadow-sm text-center">
                              <p className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-3">Impact net en 30 jours</p>
                              <p className="text-5xl font-bold text-[#1B7D3A] tracking-tighter mb-2">+ 12 400 €</p>
                              <p className="text-sm text-gray-500 font-medium mb-6">de revenus supplémentaires récupérés</p>
                              <button onClick={() => onNavigate("/audit")} className="text-sm font-bold text-gray-900 border-b-2 border-gray-300 hover:border-gray-900 transition-colors pb-0.5 inline-flex items-center gap-1">
                        ...
                        <>
                          <div className="flex items-center gap-3 mb-10">
                            <div className="px-3 py-1 bg-gray-50 border border-gray-200 rounded-full text-xs font-bold uppercase tracking-widest text-gray-600">Exemple de déploiement</div>
                            <span className="text-gray-900 font-bold">Agence immobilière — Île-de-France</span>
                          </div>
                          <div className="grid md:grid-cols-2 gap-12 items-center">
                            <div className="space-y-8">
                              <div>
                                <p className="text-xs font-bold uppercase tracking-widest text-gray-500 mb-1">Problème identifié</p>
                                <p className="text-xl font-bold text-gray-900 leading-tight">50% des leads non recontactés sous 24h, collecte documentaire manuelle, zéro relance systématique.</p>
                              </div>
                              <div>
                                <p className="text-xs font-bold uppercase tracking-widest text-gray-500 mb-1">Solution déployée</p>
                                <p className="text-base text-gray-500 font-medium leading-relaxed">3 agents IA : qualification + prise de RDV automatique, collecte documentaire intelligente, relance progressive des prospects inactifs.</p>
                              </div>
                              <div className="flex gap-12">
                                <div>
                                  <p className="text-xs font-bold uppercase tracking-widest text-gray-500 mb-1">Avant</p>
                                  <p className="text-2xl font-bold text-gray-500 line-through">12 RDV/mois</p>
                                </div>
                                <div>
                                  <p className="text-xs font-bold uppercase tracking-widest text-[#1B7D3A] mb-1">Après 30 jours</p>
                                  <p className="text-3xl font-bold text-gray-900 tracking-tight">19 RDV/mois</p>
                                </div>
                              </div>
                            </div>
                            <div className="bg-white rounded-3xl p-8 border border-gray-200 shadow-sm text-center">
                              <p className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-3">Impact en 30 jours</p>
                              <p className="text-5xl font-bold text-[#1B7D3A] tracking-tighter mb-2">+58%</p>
            ...
            {/* ============================================ */}
            <section className="py-24 bg-white border-t border-gray-200 px-6 relative z-10">
              <div className="max-w-4xl mx-auto">
                <FadeInUp className="text-center mb-16">
                  <p className="text-xs font-bold text-gray-500 uppercase tracking-[0.2em] mb-6">
                    Pourquoi Actero
                  </p>
                  <h2 className="text-4xl md:text-5xl font-bold tracking-tighter text-gray-900 mb-6 leading-tight">
                    Pas un outil de plus à gérer.
                    <br />
                    <span className="text-[#1B7D3A]">
                ...
                <div className="bg-white rounded-3xl border border-gray-200 overflow-hidden">
                  <div className="grid grid-cols-2 border-b border-gray-200 bg-gray-50">
                    <div className="p-6 md:p-8 border-r border-gray-200">
                      <p className="text-lg font-bold tracking-tight text-gray-500 line-through">Outils en self-service</p>
                    </div>
                    <div className="p-6 md:p-8">
                      <p className="text-xl font-bold tracking-tight text-gray-900 flex items-center gap-2">
                        <span className="w-2 h-2 rounded-full animate-pulse bg-[#1B7D3A]"></span>
                        Actero
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="divide-y divide-gray-200">
                    {(vertical === 'ecommerce' ? [
                      ...
                      <div key={i} className="grid grid-cols-2 group hover:bg-gray-50 transition-colors">
                        ...
                        <div className="p-6 md:p-8 flex items-center gap-3">
                          <CheckCircle2 className="w-4 h-4 flex-shrink-0 text-[#1B7D3A]" />
                  ...
                  <div className="bg-white rounded-3xl overflow-hidden relative border border-gray-200">
                    ...
                    <div className="grid md:grid-cols-2 relative z-10">
                      ...
                      <div className="p-8 md:p-12 border-b md:border-b-0 md:border-r border-gray-200">
                        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-bold mb-6 uppercase tracking-widest bg-gray-50 border border-gray-200 text-gray-600">
                        ...
                        <div className="space-y-4 mb-8">
                          {(vertical === 'ecommerce' ? [
                            ...
                            <div key={i} className="flex items-center gap-3">
                              <CheckCircle2 className="w-5 h-5 flex-shrink-0 text-[#1B7D3A]" />
                        ...
                        <div className="pt-6 border-t border-gray-200">
                          ...
                          <div className="flex items-baseline gap-2 mb-3">
                            <span className="text-4xl font-bold tracking-tight text-[#1B7D3A]">800€</span>
                      ...
                      <div className="p-8 md:p-12 flex flex-col justify-between">
                        <div>
                          <h4 className="text-lg font-bold text-gray-900 mb-6">C'est fait pour vous si :</h4>
                          <div className="space-y-5 mb-10">
                            {(vertical === 'ecommerce' ? [
                              {
                                icon: <ShoppingCart className="w-5 h-5 text-[#1B7D3A]" />,
                              ...
                              {
                                icon: <Target className="w-5 h-5 text-[#1B7D3A]" />,
                                text: "Vous voulez scaler votre CA sans multiplier vos coûts opérationnels"
                              },
                            ] : [
                              {
                                icon: <Building2 className="w-5 h-5 text-[#1B7D3A]" />,
                              ...
                              <div key={i} className="flex items-start gap-4">
                                ...
                                <p className="text-gray-500 font-medium leading-relaxed text-[15px]">{item.text}</p>
                              </div>
                            ))}
                          </div>
                        </div>
                        ...
                        <div>
                          <MagneticButton
                            onClick={() => onNavigate("/audit")}
                            className="w-full bg-[#1B7D3A] text-white px-8 py-4 rounded-full font-bold flex items-center justify-center gap-2 hover:bg-[#166B32] transition-colors mb-4"
                          >
            ...
            <section id="faq" className="py-24 bg-white px-6 relative z-10">
              <div className="max-w-3xl mx-auto">
                <FadeInUp className="text-center mb-16">
                  <h2 className="text-3xl md:text-5xl font-bold tracking-tighter text-gray-900 mb-4">Questions fréquentes</h2>
                  <p className="text-gray-500 font-medium">Tout ce que vous devez savoir avant de commencer.</p>
                </FadeInUp>
                <div className="space-y-4">
                  {(vertical === 'ecommerce' ? [
                    ...
                    <div key={i} className="border border-gray-200 rounded-2xl bg-white overflow-hidden hover:border-gray-300 transition-colors">
            ...
            <section className="py-24 md:py-32 bg-white px-6 relative z-10">
              <div className="max-w-4xl mx-auto">
                <FadeInUp>
                  <div className="relative bg-gray-50 rounded-3xl p-10 md:p-16 border border-gray-200 overflow-hidden text-center">
                    {/* Clean — no background effects */}

                    <div className="relative z-10">
                      <div className="w-16 h-16 bg-white border border-gray-200 rounded-2xl flex items-center justify-center mx-auto mb-8">
                        <CalendarCheck className="w-8 h-8 text-[#1B7D3A]" />
                      </div>

                      <h2 className="text-3xl md:text-5xl font-bold tracking-tighter text-gray-900 mb-6">
                        {vertical === 'ecommerce'
