...
// Dev-only mock audit used when `?preview=1` is on a dev build.
// Stays at module scope so the initial useState() can read it without
// declaring it inside the effect (avoids react-hooks/set-state-in-effect).
const PREVIEW_MOCK = {
